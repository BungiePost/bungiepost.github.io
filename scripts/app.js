    ...
    $("#searchUser").autocomplete({
        source: function( request, response ) {
            $.ajax({
                ...
                url: 'http://www.bungie.net/Platform/User/SearchUsers/?q=' + $("#searchUser").val(),
    ...
    var viewModel = kendo.observable({
        ...
        searchForUser: function (uid) {
            ...
            $.ajax({
                ...
                url: 'http://www.bungie.net/Platform/User/GetBungieNetUserById/' + uid + '/',
        ...
        getPostHistory: function (id) {
            ...
            for (var i = 1; i <= numberOfPages; i++) {
                $.ajax({
                    ...
                    url: 'https://www.bungie.net/Platform/Activity/User/' + id + '/Activities/Forums/?lc=en&fmt=true&lcin=true&itemsPerPage=20&currentpage=' + i + '&format=0',
